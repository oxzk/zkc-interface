...
export const WalletWidget = ({ open, setOpen }) => {
    ...
    const { disconnectWallet, currentAccount, connected, chainId, loading, watchModeOnlyAddress } = useWeb3Context();
        ...
        <>
            {
                loading ? (
                    ...
                    <Button
                        ...
                        startIcon={connected && <AccountCircleIcon></AccountCircleIcon>}
                        endIcon={connected &&
                            (
                                <SvgIcon
                                    sx={{
